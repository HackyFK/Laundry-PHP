...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 30, 2024 at 04:41 AM
...
(1, 'Iman Abadi', '85394759435', 'Parakancanggah'),
(3, 'Hacky Zalman Alvista', '082313861862', 'Jln. Baturgede 2, Petambakan, Banjarnegara');
...
(1, '2024-11-28', 1, 20000, 2, '2025-01-22', 1),
(2, '2024-11-30', 3, 10000, 1, '2024-12-01', 0);
...
--
ALTER TABLE `pakaian`
  MODIFY `pakaian_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
