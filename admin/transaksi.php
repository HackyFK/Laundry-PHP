                ...
                while($d=mysqli_fetch_array($data)){
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="transaksi_hapus.php?id=<?php echo $d['transaksi_id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda yakin ingin membatalkan?');">Batalkan</a>
                        </td>
                    </tr>
                    <?php
                }
