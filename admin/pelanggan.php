                ...
                while($d=mysqli_fetch_array($data)){
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="pelanggan_hapus.php?id=<?php echo $d['pelanggan_id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus data pelanggan ini?');">Hapus</a>
                        </td>
                    </tr>
                    <?php
                }
